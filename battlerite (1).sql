...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 30 Juin 2017 à 13:48
...
(1, 1, 'Discussions G&eacute;n&eacute;rales'),
(2, 1, 'News & Patchnotes'),
(3, 1, 'Vid&eacute;os'),
...
(129, 'Howkalm', 'ezdzedz', 'admin'),
(130, 'Howkalm', 'refef', 'admin'),
(131, 'Howkalm', 'fzfzfez', 'admin'),
(132, 'Howkalm', 'Bonjour j''aime le riz\n', 'admin');
...
(18, 'Chawouie Squaad', 10, 10, 10, '10.jpg', 1, 1);
...
(10, 'Howkalm', 'howkalm@gmail.com', 'b85ac4fc71368717d0e39f931de9a96570dfdf76', 'soon dans le e-sport', 'admin', 0);
...
CREATE TABLE IF NOT EXISTS `wiki` (
  ...
  `nom_champion` text NOT NULL,
  `classe_champion` text NOT NULL,
...
INSERT INTO `wiki` (`id_champion`, `nom_champion`, `classe_champion`) VALUES
(1, 'Ashka', 'Ranged'),
(2, 'Ezmo', 'Ranged'),
(3, 'Iva', 'Ranged'),
(4, 'Jade', 'Ranged'),
