                        ...
                        <div class="row multi-columns-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="nk-blog-post">
                                    ...
                                    <div class="nk-gap"></div>
                                    <a href="patchnote.php" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">En savoir plus</a>
                                </div>
                                <!-- END: Post -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="nk-blog-post">
                                    ...
                                    <div class="nk-gap"></div>
                                    <a href="news.php" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">En savoir plus</a>
                                </div>
                                <!-- END: Post -->
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="nk-blog-post">
                                    ...
                                    <div class="nk-gap"></div>
                                    <a href="video.php" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">En savoir plus</a>
                                </div>
                                <!-- END: Post -->
                            </div>
                        </div>
