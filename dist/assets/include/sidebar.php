                        ...
                        <div class="nk-widget nk-widget-highlighted">
                            ...
                            <div class="nk-widget-content">
                                ...
                                <?php if (isset($_SESSION['id']) and $muted['id_utilisateur'] !== $_SESSION['id'])
                                    ...
                                    <form method="post" class="nk-form-ajax" id="cform">
                                        <textarea class="form-control" name="message" id="notes" placeholder="Message ... (140 caractères max)" rows="3"></textarea>
                                        <input type="submit" value="Envoyer" class="nk-btn nk-btn-rounded nk-btn-color-main-1 nk-btn-hover-color-white" onclick="resetMessage()">
                                    </form>
                                    <?php }
                                    else
                                    {
        ...
        <div class="nk-gap-4"></div>
                    <script>
                        function resetMessage() {
                            setTimeout(function(){document.getElementById("cform").reset();}, 500);
                        }
                    </script>